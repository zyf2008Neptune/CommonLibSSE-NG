...
namespace RE
{
	...
	{
		REL::Relocation<Inventory3DManager**> singleton{ REL::RelocationID(517051, 403559) };
		return *singleton;
	}
	...
	void Inventory3DManager::UpdateItem3D(InventoryEntryData* a_objDesc)
	{
		...
		REL::Relocation<func_t> func{ REL::RelocationID(50884, 51757) };
	...
	void Inventory3DManager::UpdateMagic3D(TESForm* a_form, std::uint32_t a_arg2)
	{
		...
		REL::Relocation<func_t> func{ REL::RelocationID(50885, 51758) };
	...
	void Inventory3DManager::Clear3D()
	{
		...
		REL::Relocation<func_t> func{ REL::RelocationID(50886, 51759) };
		return func(this);
	}
	...
	std::uint32_t Inventory3DManager::Render()
	{
		...
		REL::Relocation<func_t> func{ REL::RelocationID(50882, 51755) };
		return func(this);
	}
}
