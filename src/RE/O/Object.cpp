...
namespace RE
{
	namespace BSScript
	{
		...
		VMHandle Object::GetHandle() const
		{
			...
			REL::Relocation<func_t> func{ REL::RelocationID(97463, 104247) };
			return func(this);
		}
		...
		void Object::IncRef()
		{
			...
			REL::Relocation<func_t> func{ REL::RelocationID(97468, 104252) };
			return func(this);
		}
		...
		std::uint32_t Object::DecRef()
		{
			...
			REL::Relocation<func_t> func{ REL::RelocationID(97469, 104253) };
			return func(this);
		}
		...
		void Object::Dtor()
		{
			...
			REL::Relocation<func_t> func{ REL::RelocationID(97462, 104246) };
			return func(this);
		}
	}
}
