...
namespace RE
{
	namespace BSScript
	{
		...
		VMHandle Object::GetHandle() const
		{
			...
			REL::Relocation<func_t> func{ RE::Offset::BSScript::Object::GetHandle };
			return func(this);
		}
		...
		void Object::IncRef()
		{
			...
			REL::Relocation<func_t> func{ RE::Offset::BSScript::Object::IncRef };
			return func(this);
		}
		...
		std::uint32_t Object::DecRef()
		{
			...
			REL::Relocation<func_t> func{ RE::Offset::BSScript::Object::DecRef };
			return func(this);
		}
		...
		void Object::Dtor()
		{
			...
			REL::Relocation<func_t> func{ RE::Offset::BSScript::Object::Dtor };
			return func(this);
		}
	}
}
