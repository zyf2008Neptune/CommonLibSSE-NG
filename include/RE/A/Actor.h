...
namespace RE
{
	...
	public:
		...
		bool                    InitiateTresPassPackage(TrespassPackage* a_trespassPackage);                                                                                                                     // 0D7 - { return 0; }
		void                    InitiateDialogue(Actor* a_target, PackageLocation* a_loc1, PackageLocation* a_loc2);                                                                                             // 0D8
		void                    SetSize(float a_size);                                                                                                                                                           // 0D9
		...
		void                    StopCombat();                                                                                                                                                                    // 0E5
		float                   CalcArmorRating();                                                                                                                                                               // 0E6 - { return 0.0; }
		float                   GetArmorBaseFactorSum();                                                                                                                                                         // 0E7 - { return 0.0; }
		float                   CalcUnarmedDamage();                                                                                                                                                             // 0E8 - { return 0; }
		void                    Unk_E9(void);                                                                                                                                                                    // 0E9 - { return 0; }
		void                    Unk_EA(void);                                                                                                                                                                    // 0EA - { return 0; }
		float                   GetRunSpeed();                                                                                                                                                                   // 0EB
		float                   GetJogSpeed();                                                                                                                                                                   // 0EC
		float                   GetFastWalkSpeed();                                                                                                                                                              // 0ED
		float                   GetWalkSpeed();                                                                                                                                                                  // 0EE
		void                    WeaponSwingCallBack();                                                                                                                                                           // 0EF
		void                    SetActorStartingPosition();                                                                                                                                                      // 0F0
		bool                    MoveToHigh();                                                                                                                                                                    // 0F1
		bool                    MovetoLow();                                                                                                                                                                     // 0F2
		bool                    MovetoMiddleLow();                                                                                                                                                               // 0F3
		bool                    MoveToMiddleHigh();                                                                                                                                                              // 0F4
		...
		bool                    DrinkPotion(AlchemyItem* a_potion, ExtraDataList* a_extralist);                                                                                                                  // 10F
		...
		void                    ModifyMovementData(float a_delta, NiPoint3& a_arg3, NiPoint3& a_arg4);                                                                                                           // 11A
