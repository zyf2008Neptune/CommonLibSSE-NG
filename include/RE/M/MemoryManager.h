...
namespace RE
{
	...
	public:
		...
		[[nodiscard]] static MemoryManager* GetSingleton()
		{
			...
			REL::Relocation<func_t> func{ RE::Offset::MemoryManager::GetSingleton };
			return func();
		}
		...
		[[nodiscard]] void* Allocate(std::size_t a_size, std::int32_t a_alignment, bool a_alignmentRequired)
		{
			...
			REL::Relocation<func_t> func{ RE::Offset::MemoryManager::Allocate };
		...
		void Deallocate(void* a_mem, bool a_alignmentRequired)
		{
			...
			REL::Relocation<func_t> func{ RE::Offset::MemoryManager::Deallocate };
		...
		[[nodiscard]] ScrapHeap* GetThreadScrapHeap()
		{
			...
			REL::Relocation<func_t> func{ RE::Offset::MemoryManager::GetThreadScrapHeap };
			return func(this);
		}
		...
		[[nodiscard]] void* Reallocate(void* a_oldMem, std::size_t a_newSize, std::int32_t a_alignment, bool a_aligned)
		{
			...
			REL::Relocation<func_t> func{ RE::Offset::MemoryManager::Reallocate };
