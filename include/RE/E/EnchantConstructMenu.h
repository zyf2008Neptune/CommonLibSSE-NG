...
namespace RE
{
	namespace CraftingSubMenus
	{
		...
		{
		public:
			inline static constexpr auto RTTI = RTTI_CraftingSubMenusːːEnchantConstructMenu;

			class EnchantMenuCallback : public IMessageBoxCallback
			{
			public:
				inline static constexpr auto RTTI = RTTI_CraftingSubMenusːːEnchantConstructMenuːːEnchantMenuCallback;
			...
			{
			public:
				inline static constexpr auto RTTI = RTTI_CraftingSubMenusːːEnchantConstructMenuːːEnchantMenuDisenchantCallback;
			...
			{
			public:
				inline static constexpr auto RTTI = RTTI_CraftingSubMenusːːEnchantConstructMenuːːEnchantMenuCraftCallback;
			...
			{
			public:
				inline static constexpr auto RTTI = RTTI_CraftingSubMenusːːEnchantConstructMenuːːEnchantMenuExitCallback;
