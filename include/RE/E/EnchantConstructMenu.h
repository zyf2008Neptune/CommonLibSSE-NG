...
namespace RE
{
	namespace CraftingSubMenus
	{
		...
		{
		public:
			SKYRIM_ADDR static auto RTTI = RTTI_CraftingSubMenus__EnchantConstructMenu;

			class EnchantMenuCallback : public IMessageBoxCallback
			{
			public:
				SKYRIM_ADDR static auto RTTI = RTTI_CraftingSubMenus__EnchantConstructMenu__EnchantMenuCallback;
			...
			{
			public:
				SKYRIM_ADDR static auto RTTI = RTTI_CraftingSubMenus__EnchantConstructMenu__EnchantMenuDisenchantCallback;
			...
			{
			public:
				SKYRIM_ADDR static auto RTTI = RTTI_CraftingSubMenus__EnchantConstructMenu__EnchantMenuCraftCallback;
			...
			{
			public:
				SKYRIM_ADDR static auto RTTI = RTTI_CraftingSubMenus__EnchantConstructMenu__EnchantMenuExitCallback;
