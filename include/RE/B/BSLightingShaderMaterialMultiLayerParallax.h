...
namespace RE
{
	...
	{
	public:
		SKYRIM_ADDR static auto RTTI = RTTI_BSLightingShaderMaterialMultiLayerParallax;
		SKYRIM_ADDR static auto VTABLE = VTABLE_BSLightingShaderMaterialMultiLayerParallax;
