...
namespace RE
{
	...
	{
	public:
		inline static auto RTTI = RTTI_hkbStateMachine;
		...
		{
		public:
			inline static auto RTTI = RTTI_hkbStateMachine__StateInfo;
		...
		{
		public:
			inline static auto RTTI = RTTI_hkbStateMachine__TransitionInfoArray;
