...
namespace RE
{
	struct hkContainerHeapAllocator
	{
		...
		{
			inline static constexpr auto RTTI = RTTI_hkContainerHeapAllocatorːːAllocator;
		...
		{
			REL::Relocation<hkContainerHeapAllocator::Allocator*> singleton{ REL::RelocationID(510713, 383828) };
