...
namespace RE
{
	...
	public:
		...
		auto                        format_as(NiColor v)
		{
			return fmt::format("({:.1f}, {:.1f}, {:.1f})", v.red, v.green, v.blue);
		}
	...
	public:
		...
		auto format_as(NiColorA v)
		{
			return fmt::format("({:.1f}, {:.1f}, {:.1f}, {:.1f})", v.red, v.green, v.blue, v.alpha);
		}
