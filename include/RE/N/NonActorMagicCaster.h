...
namespace RE
{
	...
	public:
		...
		void           CastSpellImmediate(SpellItem* a_spell, bool a_noHitEffectArt, TESObjectREFR* a_target, float a_effectiveness, bool a_hostileEffectivenessOnly, float a_magnitudeOverride, Actor* a_cause) override;  // 01
