function(commonlibsse_parse_version VERSION)
    ...
    string(STRIP ${CMAKE_MATCH_5} CMAKE_MATCH_5)
    string(STRIP ${CMAKE_MATCH_7} CMAKE_MATCH_7)
    set(COMMONLIBSSE_VERSION_MATCH TRUE PARENT_SCOPE)
    set(COMMONLIBSSE_VERSION_MAJOR "${CMAKE_MATCH_1}" PARENT_SCOPE)
    message("Setting major version to ${CMAKE_MATCH_1}")
    ...
    if(DEFINED CMAKE_MATCH_3 AND CMAKE_MATCH_3 MATCHES "^[0-9]+$")
        message("Setting minor version to ${CMAKE_MATCH_3}")
        set(COMMONLIBSSE_VERSION_MINOR "${CMAKE_MATCH_3}" PARENT_SCOPE)
    endif()

    if(DEFINED CMAKE_MATCH_5 AND CMAKE_MATCH_5 MATCHES "^[0-9]+$")
        message("Setting patch version to ${CMAKE_MATCH_5}")
        set(COMMONLIBSSE_VERSION_PATCH "${CMAKE_MATCH_5}" PARENT_SCOPE)
    endif()

    if(DEFINED CMAKE_MATCH_7 AND CMAKE_MATCH_7 MATCHES "^[0-9]+$")
        message("Setting tweak version to ${CMAKE_MATCH_7}")
