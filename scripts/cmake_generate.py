...
def main():
	...
	make_header("RE", "Skyrim.h", { "BSCoreTypes.h", "CreationClubMenu.h", "Offsets.h", "Offsets_NiRTTI.h", "Offsets_RTTI.h", "Offsets_VR.h", "Offsets_VR_NiRTTI.h", "Offsets_VR_RTTI.h", "SFTypes.h", "WorldSpaceMenu.h" })
